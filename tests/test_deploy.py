...
class DeployTest(unittest.TestCase):
    ...
    def test_deploy_wrong(self):
        ...
        result = deploy("http://192.168.0.20:8000/deploy/","shimil", "passme", "Test_Boxoffice_wrong")
    ...
    def test_deploy(self):
        ...
        print os.listdir(os.getcwd())
        result = deploy("http://192.168.0.20:8000/deploy/","shimil", "passme", "Test_Boxoffice")
